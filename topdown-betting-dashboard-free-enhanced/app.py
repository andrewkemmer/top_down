...
if fetch:
    if not api_key:
        ...
        try:
            ...
            # Persistent selected books in session state
            ...
            for sport in selected_sports:
                ...
                # Extract all available sportsbooks
                all_books = list({bmk['key'] for ev in raw_events for bmk in ev.get("bookmakers", [])})

                # Fix: ensure defaults exist in options
